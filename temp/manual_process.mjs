import { enhancedFileProcessorService } from '/app/src/services/enhancedFileProcessorService.js';
import fs from 'fs';
...
(async () => {
  try {
    ...
    // If no files in tmpDir, check /app/uploads as fallback
    ...
    const fileObj = { originalname: target, path: filePath };
