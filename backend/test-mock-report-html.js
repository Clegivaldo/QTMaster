...
async function run() {
  try {
    ...
    // Prepare charts
    const chartData = svc.prepareChartData(mockReportData.sensorData, mockReportData.validation.chartConfig);
    ...
    fs.writeFileSync('mock-test-report.html', html, 'utf-8');
    console.log('✅ mock-test-report.html saved');
